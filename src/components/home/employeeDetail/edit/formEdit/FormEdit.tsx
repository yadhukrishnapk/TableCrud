...
const EditEmployeeForm: React.FC<EditEmployeeFormProps> = ({
  ...
  const handleSubmit = async ({ values }: { values: Partial<EmployeeResponse> }) => {
    const formattedData: Partial<EmployeeResponse> = {
      id: formData.id,
              ...
              <>
                  ...
                  <Row>
                    <Col md={6}>
                      ...
                      <FormField
                        ...
                        name="phone"
                        formatter="+91##########"
                        parser={(value: string) => value.replace("+91 ", "").replace(/-/g, "")}
                ...
                <div className="d-flex justify-content-end gap-2 mt-4">
                  ...
                  <Button
                    type="submit"
                    variant="primary"
                    disabled={isSubmitting || (formState.pristine && !profilePictureChanged)}
                    className="px-4"
                  >
                    {isSubmitting ? (
                      <>
